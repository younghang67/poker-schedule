...
<form action="" method="get">
    <div id="ticket">
        <div class="container-xs">
            <div class="row">
            <div class="col-sm-12 filter-border">
              <div class="title">
                  <h3>ポーカースケジュール</h3>
              </div><!-- title -->
                ...
                <div class="row cus-form1">
                    ...
                    <h6>開催日</h6>
                    <div class="calender">
                    <div class="col-sm-6 calender-from">
                        <input type="date" value="<?php echo $start_date_from;?>" name="start_date_from" class="form-control">
                    </div><!-- col-sm-6 -->
                  <P class="calender-divider"><B>~</B></P>
                    <div class="col-sm-6 calender-to">
                ...
                <div class="row cus-form2">
                  <div class="col-sm-6 right_form">
                    ...
                    <h6>ゲーム</h6>
                    <select name="game" class="form-select game-form" id="TourneyGame"> 
                      <option value=""><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">all</font></font></option> 
                ...
                <input type="hidden" name="exclude" id="TourneyExclude_" value="0">
                    ...
                    <p class="check-box-text">シットアンドゴー除外</p>
                    <p class="table-note">※新しいトーナメントから最大50件を表示します</p>
                </div>
        ...
        <div class="row">
          <div class="schedule_content">
            ...
            <div  class="table-responsive text-nowrap cus-schedule-table"> <!-- cus-table table style -->
              <table id="t01">
                <tr>
                  <th class="table-topic">開催日</th>
                  <th class="table-topic">トーナメント</th> 
                  <th class="table-topic">店舗</th>
                </tr>
